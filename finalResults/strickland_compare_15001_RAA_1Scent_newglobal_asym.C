...
void strickland_compare_15001_RAA_1Scent_newglobal_asym(int istate=1) //1 or 2 (1S or 2S)
{
  setTDRStyle();
...
//  gRAA_int_sys[0]->SetMaximum(1.3);
  ...
  c1->SaveAs(Form("Strickland_%dS_comp15001_RAA_vs_cent_newglobal_asym.pdf",istate));
  c1->SaveAs(Form("Strickland_%dS_comp15001_RAA_vs_cent_newglobal_asym.png",istate));
