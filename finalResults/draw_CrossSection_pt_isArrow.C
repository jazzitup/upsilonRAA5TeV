...
void draw_CrossSection_pt_isArrow(int ppAA=2, bool isArrow=true) //1=pp, 2=AA
{
  setTDRStyle();
...
//  double relsys = 0.1;
  ...
  double lower68[n3s] = {lower68XS_pt1,lower68XS_pt2};
  double upper68[n3s] = {upper68XS_pt1,upper68XS_pt2};
  double lower95[n3s] = {lower95XS_pt1,lower95XS_pt2};
  double upper95[n3s] = {upper95XS_pt1,upper95XS_pt2};
...
//  }
  ...
  TLegend *leg= new TLegend(0.62, 0.61, 0.83, 0.71);
  SetLegendStyle(leg);
