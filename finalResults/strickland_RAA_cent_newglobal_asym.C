...
void strickland_RAA_cent_newglobal_asym(bool isArrow =true)
{
  setTDRStyle();
...
//  CMS_lumi( c1, iPeriod, iPos );
  ...
  globtex->DrawLatex(0.5*(1-0.032*600/xlonger), sz_init-sz_step*2-sz_allign, "0-100%");
	...
	c1->Update();
  c1->SaveAs(Form("Strickland_RAA_vs_cent_isArrow%d_newglobal_asym.png",(int)isArrow));

  c1->SaveAs(Form("Strickland_RAA_vs_cent_isArrow%d_newglobal_asym.pdf",(int)isArrow));
/*
	///////////////////////////////////////////////////////////////////
	//// save as a root file
