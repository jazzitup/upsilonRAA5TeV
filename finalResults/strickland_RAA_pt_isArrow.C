...
//  leg_strick->Draw("same");
  ...
  drawText2("4#pi#eta/s=1", line_x_end+1, line_y-0.015, 16);
  drawText2("4#pi#eta/s=2", line_x_end+1, line_y-line_y_diff*1-0.015, 16);
  drawText2("4#pi#eta/s=3", line_x_end+1, line_y-line_y_diff*2-0.015, 16);
