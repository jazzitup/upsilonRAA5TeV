...
void doFitUpsilon_Data_pas_AA_pt02_y0408(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 1.971 , 1.153, 3.821);
  ...
  RooRealVar n1s_1("n1s_1","power order", 1.904 , 1.531, 3.702);
