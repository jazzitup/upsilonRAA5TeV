...
void doFitUpsilon_Data_pas_AA_pt04_1(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.05 , 1.253, 3.71);
  ...
  RooRealVar *f1s = new RooRealVar("f1s","1S CB fraction", 0.5, 0.3, 0.8);
...
//    x1s->setVal(initPset.x1s);
  ...
  RooRealVar *nSig2s= new RooRealVar("nSig2s"," 2S signals", 0,2000);
