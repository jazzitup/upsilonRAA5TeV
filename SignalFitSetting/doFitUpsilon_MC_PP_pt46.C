    ...
    ) 
{
  ...
  RooRealVar x1s("x1s","sigma fraction 1s 2nd CB", 0.5, 0., 2.1);
  ...
  //integrated, y<2.4
  RooRealVar alpha1s("alpha1s","tail shift", 1.20, 1.16, 4.65);
  RooRealVar n1s("n1s","power order", 1.01, 1.0011,2.1062);
  ...
  RooRealVar *sl1 = new RooRealVar("sl1","sl1",-0.1,-2.5,3);
  RooRealVar *cnst1 = new RooRealVar("cnst1","cnst1",0.1,-3.,3);
