...
void makeOnia2AccTree(int iCat_ = 0) { // iCat_ = 0 (1S), 1 (2S), 2 (3S)
  ...
  if(iCat_ == 0) fname = "../MCFiles/OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_nofilter_pp502Fall15-MCRUN2_71_V1-v1_GENONLY.root";
  if(iCat_ == 1) fname = "../MCFiles/OniaTree_Ups2SMM_5p02TeV_TuneCUETP8M1_nofilter_pp502Fall15-MCRUN2_71_V1-v1_GENONLY.root";
  if(iCat_ == 2) fname = "../MCFiles/OniaTree_Ups3SMM_5p02TeV_TuneCUETP8M1_nofilter_pp502Fall15-MCRUN2_71_V1-v1_GENONLY.root";
  ...
  if(iCat_ == 0) fout = "skimedForAcc_MC_Ups1S_20170606.root";
  if(iCat_ == 1) fout = "skimedForAcc_MC_Ups2S_20170606.root";
  if(iCat_ == 2) fout = "skimedForAcc_MC_Ups3S_20170606.root";
  cout <<"* file ::" << fout << endl;
