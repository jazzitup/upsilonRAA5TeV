...
int draw_bkgparam_pt(TString szAA = "PP", int states =1)
{
  ...
  //// histogram
  TH1D* h1_lambda = new TH1D("h1_lambda","h1_lambda;p_{T} (GeV/c);#lambda",nBin,binArr); 
  TH1D* h1_mu = new TH1D("h1_mu","h1_mu;p_{T} (GeV/c);#mu",nBin,binArr); 
  TH1D* h1_sigma = new TH1D("h1_sigma","h1_sigma;p_{T} (GeV/c);#sigma",nBin,binArr); 
  ...
  c_lambda->SaveAs(Form("bkgparam/pt_lambda_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_mu->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_mu->SaveAs(Form("bkgparam/pt_mu_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_sigma->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_sigma->SaveAs(Form("bkgparam/pt_sigma_%s_%dS.pdf",szAA.Data(),states));
