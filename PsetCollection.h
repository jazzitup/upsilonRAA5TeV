...
if ( collId == kPPDATA) 
{
  ...
  //New Bin for 2S
  if ( binMatched( 4, 0, 30, 0, 0.8) ) { setSignalParMC( 3.3, 1.58721, 0.0869891, 9.45904, 0.327084, 0.646619 );}
  if ( binMatched( 4, 0, 30, 0.8, 1.6) ) { setSignalParMC( 3.34101, 1.7953, 0.0813591, 9.45382, 0.431361, 1.48029 );}
  if ( binMatched( 4, 0, 30, 1.6, 2.4) ) { setSignalParMC( 2.16579, 1.91729, 0.117034, 9.45, 0.535983, 1.50318 );}
  //New Bin for 3S
  if ( binMatched( 4, 0, 6, 0, 2.4) ) { setSignalParMC( 3.74613, 1.57539, 0.0654956, 9.45752, 0.529678, 1.96308 );}
  if ( binMatched( 4, 6, 30, 0, 2.4) ) { setSignalParMC( 3.86228, 1.55607, 0.0678253, 9.45518, 0.540205, 1.87503 );}
...
//  if ( binMatched( 4, 0, 30, 0, 0.4) ) { setSignalParMC( 1.36778, 1.90995, 0.0895886, 9.45809, 0.184539, 0.605352 );} 
  ...
  //if ( binMatched( 4, 0, 30, 0, 2.4) )   { setSignalParMC(3.65  ,  1.52 ,  0.0675 ,  9.4577  ,  0.556 ,  1.94 );} 
...
{ 
  ...
  //New Bin for 2S
  if ( binMatched( 4, 0, 4, 0, 2.4, 0, 200) ) { setSignalParMC( 3.86157, 1.56371, 0.0708133, 9.4563, 0.60964, 1.89557 );}
  if ( binMatched( 4, 4, 9, 0, 2.4, 0, 200) ) { setSignalParMC( 3.87664, 1.52534, 0.0687926, 9.45611, 0.571881, 1.87868 );}
  if ( binMatched( 4, 9, 30, 0, 2.4, 0, 200) ) { setSignalParMC( 3.87158, 1.50745, 0.0701046, 9.45494, 0.577416, 1.86921 );}
  if ( binMatched( 4, 0, 30, 0, 0.8, 0, 200) ) { setSignalParMC( 1.42423, 1.942, 0.0859051, 9.45843, 0.386836, 0.654548 );}
  if ( binMatched( 4, 0, 30, 0.8, 1.6, 0, 200) ) { setSignalParMC( 2.14016, 2.13028, 0.0766737, 9.4506, 0.372407, 1.56784 );}
  if ( binMatched( 4, 0, 30, 1.6, 2.4, 0, 200) ) { setSignalParMC( 2.32982, 1.97645, 0.0746161, 9.45, 0.0848621, 1.99949 );}
  //New Bin for 3S
  if ( binMatched( 4, 0, 6, 0, 2.4, 0, 200) ) { setSignalParMC( 3.29469, 1.57405, 0.0660745, 9.45638, 0.497881, 1.85613 );}
  if ( binMatched( 4, 6, 30, 0, 2.4, 0, 200) ) { setSignalParMC( 3.34351, 1.5445, 0.0690201, 9.45557, 0.556208, 1.86493 );}
...
if ( collId == kPPDATA) 
{
  ...
  if ( binMatched( 4, 2, 4, 0, 2.4) )   { setSignalParMC( 2.08672, 1.60167, 0.0672575, 9.45795, 0.592143, 1.94477 );} 
  if ( binMatched( 4, 4, 6, 0, 2.4) )   { setSignalParMC( 2.29491, 1.47759, 0.0687515, 9.4588, 0.610067, 1.88195 );} 
  if ( binMatched( 4, 6, 9, 0, 2.4) )   { setSignalParMC( 2.71234, 1.43285, 0.0698408, 9.45636, 0.626443, 1.86202 );} 
  if ( binMatched( 4, 9, 12, 0, 2.4) )   { setSignalParMC( 2.8978, 1.34035, 0.0656353, 9.45661, 0.556774, 1.87762 );} 
  if ( binMatched( 4, 12, 30, 0, 2.4) )   { setSignalParMC( 1.71537, 1.60971, 0.0705885, 9.45584, 0.604019, 1.82084 );} 
  if ( binMatched( 4, 0, 4, 0, 2.4) )   { setSignalParMC( 2.28449, 1.56481, 0.0659498, 9.45813, 0.579601, 1.97637 );} 
  if ( binMatched( 4, 4, 9, 0, 2.4) )   { setSignalParMC( 3.42638, 1.39826, 0.0702194, 9.45763, 0.642078, 1.88153 );} 
  if ( binMatched( 4, 9, 30, 0, 2.4) )   { setSignalParMC( 2.0917, 1.5035, 0.0684199, 9.4561, 0.579746, 1.83921 );} 
  if ( binMatched( 4, 0, 30, 0, 0.8) )   { setSignalParMC( 3.02439, 7.01656, 0.0978785, 9.45642, 0.317496, 0.571911 );} 
  if ( binMatched( 4, 0, 30, 0.8, 1.6) )   { setSignalParMC( 5.03284, 7.20186, 0.0820947, 9.45214, 0.476736, 1.50707 );} 
  if ( binMatched( 4, 0, 30, 1.6, 2.4) )   { setSignalParMC( 6.44117, 1.58396, 0.115962, 9.44934, 0.486651, 1.39253 );} 
  if ( binMatched( 4, 0, 6, 0, 2.4) )   { setSignalParMC( 3.32642, 1.40923, 0.0674286, 9.45872, 0.607069, 1.93873 );} 
  if ( binMatched( 4, 6, 30, 0, 2.4) )   { setSignalParMC( 2.31759, 1.47388, 0.068915, 9.4562, 0.596599, 1.8463 );} 
...
{ 
  ...
  if ( binMatched( 4, 2, 4, 0, 2.4) )   { setSignalParMC( 2.49442, 1.3997, 0.0669801, 9.45838, 0.564087, 1.80134 );} 
  if ( binMatched( 4, 4, 6, 0, 2.4) )   { setSignalParMC( 5.98079, 1.24686, 0.0702996, 9.4572, 0.672109, 1.8971 );} 
  if ( binMatched( 4, 6, 9, 0, 2.4, 0, 200) )   { setSignalParMC( 2.75829, 1.31563, 0.0671592, 9.45861, 0.575685, 1.82698 );} 
  if ( binMatched( 4, 9, 12, 0, 2.4,0,200) )   { setSignalParMC( 1.62203, 1.60689, 0.0699888, 9.45497, 0.629277, 1.88401 );} 
  if ( binMatched( 4, 12, 30, 0, 2.4) )   { setSignalParMC( 2.43427, 1.4732, 0.0728626, 9.45583, 0.64106, 1.82254 );} 
  if ( binMatched( 4, 4, 9, 0, 2.4) )   { setSignalParMC( 3.80028, 1.28266, 0.0685694, 9.45795, 0.618481, 1.84864 );} 
  if ( binMatched( 4, 0, 4, 0, 2.4) )   { setSignalParMC( 3.28877, 1.38616, 0.0673297, 9.45801, 0.594669, 1.90439 );} 
  if ( binMatched( 4, 9, 30, 0, 2.4) )   { setSignalParMC( 2.09321, 1.51896, 0.0715776, 9.45551, 0.63505, 1.84701 );} 
  if ( binMatched( 4, 0, 30, 0, 0.8) )   { setSignalParMC( 4.03613, 3.78892, 0.0734456, 9.45797, 0.749983, 0.702179 );} 
  if ( binMatched( 4, 0, 30, 0.8, 1.6) )  { setSignalParMC( 6.36843, 5.71945, 0.0817866, 9.45004, 0.460011, 1.52887 );} 
  if ( binMatched( 4, 0, 30, 1.6, 2.4) )   { setSignalParMC( 3.58397, 6.97491, 0.0576883, 9.44564, 0.0348446, 2.49889 );} 
  if ( binMatched( 4, 0, 6, 0, 2.4) )   { setSignalParMC( 3.08749, 1.34426, 0.0672534, 9.45784, 0.595552, 1.88245 );} 
  if ( binMatched( 4, 6, 30, 0, 2.4) )   { setSignalParMC( 2.49436, 1.40822, 0.0695832, 9.45684, 0.608191, 1.83204 );} 
