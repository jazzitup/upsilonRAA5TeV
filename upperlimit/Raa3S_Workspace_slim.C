...
//void Raa3S_Workspace_slim(const char* name_pbpb="ws_PbPbData_262548_263757_0cent160_0.0pt30.0_0.0y2.4.root", const char* name_pp="ws_PPData_262157_262328_-1cent1_0.0pt30.0_0.0y2.4.root", const char* name_out="fitresult_combo2.root"){
//void Raa3S_Workspace_slim(const char* name_pbpb="/cms/home/goni/work/PromptPD/upsilon_fitting_758/usercode/UpsilonAna_Run2/Fitter/Plots_8_8_2016/Integrated/FIT_PbPb_DATA_sig_2_Bkg_ErfExp1_262620_263757_0cent200_0p0pt30p0_0p0y2p4.root", const char* name_pp="myfit/FIT_PP_DATA_sig_2_Bkg_ErfExp1_262157_262328_-1cent1_0p0pt30p0_0p0y2p4.root", const char* name_out="new_fitresult_combo_0cent200.root"){
void Raa3S_Workspace_slim(const char* name_pbpb="../fitResults/fitresults_upsilon_DoubleCB_AA_DATA_pt4.0-6.0_y0.0-1.2_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI.root", const char* name_pp="../firResults/fitresults_upsilon_DoubleCB_AA_DATA_pt4.0-6.0_y0.0-1.2_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI.root", const char* name_out="fitresult_combo.root"){
   //TFile File(filename);
   ...
   RooRealVar* Raa = new RooRealVar("Raa","R_{AA}(#Upsilon (3S))",0.5,0.,1.);
   ...
   RooGenericPdf step("step", "step", "(@0 >= @1) && (@0 < @2)", RooArgList(*Raa, *leftEdge, *rightEdge));
   ws->import(step);
   //ws->factory( "Uniform::flat(dubRat)" );
   ws->factory( "Uniform::flat(Raa)" );
   ...
   ws->factory( "expr::alpha_lumipp('pow(lumipp_kappa,beta_lumipp)',lumipp_kappa,beta_lumipp[1,-5,5])" );
   ws->factory( "prod::lumipp_nom(lumipp_hi,alpha_lumipp)" );
   ws->factory( "Gaussian::constr_lumipp(beta_lumipp,glob_lumipp[1,-5,5],1)" );

   // ws->factory( "effRat1[1]" );
   // ws->factory( "effRat2[1]" );
   ws->factory( "effRat3_hi[1]" );
   ws->factory( "effRat_kappa[1]" );
   ws->factory( "expr::alpha_effRat('pow(effRat_kappa,beta_effRat)',effRat_kappa,beta_effRat[1,-5,5])" );
   // ws->factory( "prod::effRat1_nom(effRat1_hi,alpha_effRat)" );
   ws->factory( "Gaussian::constr_effRat(beta_effRat,glob_effRat[1,-5,5],1)" );
   ...
   */
   ...
   //RooFormulaVar nsig3_hi_modified("nsig3_hi_modified", "@0*@1*@2", RooArgList(*dubRat, *frac3Sv1S_pp,*nsig1_hi));
   RooFormulaVar nsig3_hi_modified("nsig3_hi_modified", "@0*@1*@2", RooArgList(*Raa, *frac3Sv1S_pp,*nsig1_hi));
   ws->import(nsig3_hi_modified);
...
//   ws->var("N_{#Upsilon(3S)}_pp")->setConstant(true);
   ...
   RooPlot *framepoi = ((RooRealVar *)poi.first())->frame(Bins(10),Range(0.,.2),Title("LL and profileLL in dubRatio"));
