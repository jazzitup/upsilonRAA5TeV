...
int draw_sigparam_rap_noerr(TString szAA = "PP", int states =1)
{
  /////////////////////////////////////////////////////////
  //// set style
  /////////////////////////////////////////////////////////
  ...
  for (int ib =0; ib < nBin; ib ++ ) {
    //// read files
    //if (szAA == "PP" ) { fileIn[ib]= new TFile(Form("./NomPlot_MC/fitresults_upsilon_DoubleCB_%s_MC_Ups1S_pt0.0-30.0_y%.1f-%.1f_muPt4.0.root",szAA.Data(),binArr[ib],binArr[ib+1])); }
    //else if (szAA == "AA" ) { fileIn[ib]= new TFile(Form("./NomPlot_MC/fitresults_upsilon_DoubleCB_%s_MC_Ups1S_pt0.0-30.0_y%.1f-%.1f_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI.root",szAA.Data(),binArr[ib],binArr[ib+1])); }
    if (szAA == "PP" ) { fileIn[ib]= new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_RAA/upsilonRAA5TeV/TEST_newNom/PAS_fitresults_upsilon_DoubleCB_%s_DATA_pt0.0-30.0_y%.1f-%.1f_muPt4.0.root",szAA.Data(),binArr[ib],binArr[ib+1])); }
    else if (szAA == "AA" ) { fileIn[ib]= new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_RAA/upsilonRAA5TeV/TEST_newNom/PAS_fitresults_upsilon_DoubleCB_%s_DATA_pt0.0-30.0_y%.1f-%.1f_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI.root",szAA.Data(),binArr[ib],binArr[ib+1])); }
...
//    else if (szAA == "AA" ) { ws[ib]= (RooWorkspace*)fileIn[ib]->Get(Form("workspace_%s_MC_Ups1S_pt0.0-30.0_y%.1f-%.1f_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI",szAA.Data(),binArr[ib],binArr[ib+1])); }
  ...
  //// histogram
  TH1D* h1_alpha1s_1 = new TH1D("h1_alpha1s_1","h1_alpha1s_1;|y|;alpha1s_1",nBin,binArr); 
  TH1D* h1_n1s_1 = new TH1D("h1_n1s_1","h1_n1s_1;|y|;n1s_1",nBin,binArr); 
  TH1D* h1_sigma1s_1 = new TH1D("h1_sigma1s_1","h1_sigma1s_1;|y|;sigma1s_1",nBin,binArr); 
  TH1D* h1_f1s = new TH1D("h1_f1s","h1_f1s;|y|;f1s",nBin,binArr); 
  TH1D* h1_x1s = new TH1D("h1_x1s","h1_x1s;|y|;x1s",nBin,binArr); 
  TH1D* h1_mass1s = new TH1D("h1_mass1s","h1_mass1s;|y|;m_{#Upsilon(1S)}",nBin,binArr); 
  ...
  c_alpha1s_1->SaveAs(Form("sigparam_noerr/rap_alpha1s_1_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_n1s_1->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_n1s_1->SaveAs(Form("sigparam_noerr/rap_n1s_1_%s_%dS.pdf",szAA.Data(),states));
  ...
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_sigma1s_1->SaveAs(Form("sigparam_noerr/rap_sigma1s_1_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_f1s->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_f1s->SaveAs(Form("sigparam_noerr/rap_f1s_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_x1s->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_x1s->SaveAs(Form("sigparam_noerr/rap_x1s_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_mass1s->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_mass1s->SaveAs(Form("sigparam_noerr/rap_mass1s_%s_%dS.pdf",szAA.Data(),states));
